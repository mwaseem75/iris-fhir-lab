# Summary
IRIS-FHIR-Lab is a web application to connect and view resources details from multiple FHIR Servers along with dynamically creating and posting FHIR resources
